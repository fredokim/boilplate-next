/**
 * Copied from react-boilerplate. The three repositories are separate remotes,
 * so the token source and its tooling are duplicated rather than published as a
 * package. react-boilerplate holds the copy to change first.
 */
