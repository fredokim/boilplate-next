...
assertIncludes(doc("PERFORMANCE_REPORT.md"), "npm run check:bundle", "PERFORMANCE_REPORT.md");
...
assertIncludes(doc(".github/PULL_REQUEST_TEMPLATE.md"), "State ownership is clear", ".github/PULL_REQUEST_TEMPLATE.md");

const readme = readRequired("README.md");
for (const required of requiredDocs.filter((path) => path.endsWith(".md") && !path.startsWith(".github"))) {
  assertIncludes(readme, required, "README.md");
}

const aiGuide = readRequired("AI_DEVELOPMENT_GUIDE.md");
for (const required of ["AI_WORKFLOW.md", "PROMPT_PLAYBOOK.md", "CODE_REVIEW_CHECKLIST.md"]) {
  assertIncludes(aiGuide, required, "AI_DEVELOPMENT_GUIDE.md");
}

// App Router specifics the React and Vue boilerplates do not have to state.
assertIncludes(aiGuide, "use client", "AI_DEVELOPMENT_GUIDE.md");
assertIncludes(aiGuide, "BOUNDARY_GUIDE.md", "AI_DEVELOPMENT_GUIDE.md");
assertIncludes(readRequired("API_CONTRACT.md"), "serverApiClient", "API_CONTRACT.md");
assertIncludes(readRequired("API_CONTRACT.md"), "clientApiClient", "API_CONTRACT.md");
