...
export const dashboardDataSourceApi = {
  salesSummary: (parameters: Parameters) =>
    requestDto({ method: "GET", url: "/api/dashboard/kpi", params: parameters }, KpiDataDto),
  trafficSeries: (parameters: Parameters) =>
    requestDto({ method: "GET", url: "/api/dashboard/chart", params: parameters }, SeriesDataDto),
  recentEvents: (parameters: Parameters) =>
    requestDto({ method: "GET", url: "/api/dashboard/table", params: parameters }, TableDataDto),
};
