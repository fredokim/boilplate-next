...
function CommonWidgetSettings({ onChange, widget }: ConfigEditorProps<DashboardWidget>) {
  ...
  return (
    <>
      ...
      />
      <label className={styles.checkbox}><input type="checkbox" checked={widget.filterConfig.useGlobalFilters} onChange={(event) => onChange({ ...widget, filterConfig: { ...widget.filterConfig, useGlobalFilters: event.target.checked } })} />Use global filters</label>
      <label className={styles.checkbox}><input type="checkbox" checked={widget.filterConfig.acceptCrossWidgetFilters} onChange={(event) => onChange({ ...widget, filterConfig: { ...widget.filterConfig, acceptCrossWidgetFilters: event.target.checked } })} />Accept cross-widget filters</label>
    </>
  );
}
